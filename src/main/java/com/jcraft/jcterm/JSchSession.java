...
public class JSchSession {
    ...
    public static JSchSession getSession(String username, String password, String hostname, int port, UserInfo userinfo,
        ...
        try {
            ...
            if (jschSession == null) {
                ...
                try {
                    session = createSession(username, password, hostname, port, userinfo, proxy);
    ...
    private static Session createSession(String username, String password, String hostname, int port, UserInfo userinfo,
            Proxy proxy) throws JSchException {
        Session session = null;
    ...
    public static interface SessionFactory {
        Session getSession(String username, String hostname, int port) throws JSchException;
    }

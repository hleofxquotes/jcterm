...
public class JCTermSwingFrame extends JFrame implements Frame, ActionListener, Runnable {
    ...
    public class MyUserInfo implements UserInfo, UIKeyboardInteractive {
        public boolean promptYesNo(String str) {
            ...
            int foo = JOptionPane.showOptionDialog(JCTermSwingFrame.this.term, str, "Warning",
    ...
    private String promptDestination(JComponent term, String[] destinations) {
        ...
        JDialog dialog = pane.createDialog(JCTermSwingFrame.this.term, "Enter username@hostname");
        dialog.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
        dialog.setVisible(true);
        Object o = pane.getValue();
